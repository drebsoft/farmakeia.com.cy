<div x-data="{ mobileMenuOpen: false }" class="z-0 relative bg-white">
    <div class="relative z-10 shadow">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
            <div>
                <a href="{{ route('homepage') }}" class="flex">
                    <span class="sr-only">Farmakeia</span>
                    <img class="h-8 w-auto sm:h-10" src="{{ url('/logo.png') }}" alt="Farmakeia">
                </a>
            </div>
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5 sm:pb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="Farmakeia">
                    </div>
                    <div class="-mr-2">
