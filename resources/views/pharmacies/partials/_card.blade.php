                ...
                <div class="ml-4">
                    <a href="{{ $pharmacy->seo_url }}">
                        <h2 class="text-lg leading-6 font-medium text-gray-900">
                            ...
                            @endif
                            @if($pharmacy->next_availability === now()->addDay()->format('Y-m-d'))
                                <span
                                    class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium leading-5 bg-blue-100 text-blue-800"
                                >
